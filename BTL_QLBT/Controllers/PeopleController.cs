...
using BTL_QLBT.Models;
using BTL_QLBT.Models.Process;

namespace BTL_QLBT.Controllers
{
    public class PeopleController : Controller
    {
        private QLBTDbContext db = new QLBTDbContext();
        ...
        public ActionResult Create()
        {
            ...
            {
                var id = model.OrderByDescending(m => m.PersonID).FirstOrDefault().PersonID;
